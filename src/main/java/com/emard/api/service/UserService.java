...
import com.emard.api.config.Constants;
import com.emard.api.domain.Authority;
import com.emard.api.domain.User;
import com.emard.api.repository.AuthorityRepository;
import com.emard.api.repository.UserRepository;
import com.emard.api.security.AuthoritiesConstants;
import com.emard.api.security.SecurityUtils;
...
public class UserService {
    ...
    public Boolean resetPassword(ResetPasswordDTO resetPasswordDTO) {
        Optional<User> user = userRepository.findOneByLogin(resetPasswordDTO.getLogin());
        if (user.isPresent()) {
            ...
            userFound.setActivated(true);
            log.info("Changed password for User: {}", user);
            this.clearUserCaches(userFound);
            return true;
        }
        return false;
    }
