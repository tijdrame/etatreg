...
public class Bpdevise implements Serializable {
    ...
    public Bpdevise codeBqe(String codeBqe) {
    ...
    public Bpdevise codeCb(String codeCb) {
        this.codeCb = codeCb;
        return this;
    }
    ...
    public Bpdevise description(String description) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Bpdevise)) {
            return false;
        }
        return id != null && id.equals(((Bpdevise) o).id);
    }
