...
public class Bpitrs implements Serializable {
    ...
    public Bpitrs description(String description) {
    ...
    public Bpitrs codeCb(String codeCb) {
        this.codeCb = codeCb;
        return this;
    }
    ...
    public Bpitrs codeBqe(String codeBqe) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Bpitrs)) {
            return false;
        }
        return id != null && id.equals(((Bpitrs) o).id);
    }
