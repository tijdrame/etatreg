...
public class CRPinfosGenerator {
    ...
    public static ByteArrayInputStream crpInfosToCsv(Iterable<CrpAtr> crpAtr, File templatefile, BankInfos bankInfos, String codeIdBank, String dateDebutPeriode, String dateFinPeriode,SecteurActiviteService secteurActivite, NatureDepotService natureDepotService, ObjetCreditService objetCreditService) throws IOException {
        ...
        for (CrpAtr crp : crpAtr) {
            ...
            if (crp != null && crp.getCenr().equals("CRP")) {
                ...
                String numDos = crp.getRefint().trim();
                String numSeq = "" + i;//++
                String numEnr = "" + i;
                String typCrp = "1";
                String codIntE = "";
                ...
                //A remettre String paysD   = crp.getCpayIso();
                ...
                //String paysD = crp.getCpayIso();//!paysD.equals("") ? paysD : crp.getCpayIso();//Si SensOpe = "1" alors paysD=crp.getCpayIso() else paysD="TG";
                String paysD   = crp.getCpayIso()!=null && !crp.getCpayIso().equals("") ? ((objetCreditService.findCodeBceaoByCodeInterne(crp.getCpayIso()))!=null ? (objetCreditService.findCodeBceaoByCodeInterne(crp.getCpayIso())) : "" ) : "" ; //Emis ou Reçu
                paysD = (!paysD.equals("") && sensOpe.equals("1")) ?  "TG" : paysD;//Si SensOpe = "1" alors paysD=crp.getCpayIso() else paysD="TG";
                
                String datOpe = crp.getDatope()!=null && !crp.getDatope().equals("") ? String.valueOf(crp.getDatope().format(dateformat)) : "31/07/2019";
                String regCpt = "1";// A remettre crp.getRegt(); //1,2,3 //mettre 1
                String nomDon = crp.getNomRes(); //
                // A remettre String codDon = crp.getNocli();
                String codDon = crp.getNocli().trim();
                ...
                //A remettre String payResB = crp.getCpayEtg();
                //String payResB = crp.getCpayEtg()!=null && !crp.getCpayEtg().equals("") ? (CountryCode.getByCode(Integer.valueOf(crp.getCpayEtg()))!=null ? CountryCode.getByCode(Integer.valueOf(crp.getCpayEtg())).getAlpha2() : "" ) : "";
                //payResB = !payResB.equals("") ? payResB : crp.getCpayEtg();//Si SensOpe = "1" alors paysB=crp.getCpayIso() else paysB="TG";
                String payResB =  crp.getCpayIso()!=null && !crp.getCpayIso().equals("") ? ((objetCreditService.findCodeBceaoByCodeInterne(crp.getCpayIso()))!=null ? (objetCreditService.findCodeBceaoByCodeInterne(crp.getCpayIso())) : "" ) : "" ; //Emis ou Reçu
                payResB = (!payResB.equals("") && sensOpe.equals("1")) ? payResB : "TG";
                //A remettre
