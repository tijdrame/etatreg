...
import { DechargementComponent } from 'app/entities/dechargement/dechargement.component';
...
describe('Component Tests', () => {
  describe('Dechargement Management Component', () => {
    let comp: DechargementComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DechargementComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dechargements && comp.dechargements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
