...
import { ChargementComponent } from 'app/entities/chargement/chargement.component';
...
describe('Component Tests', () => {
  describe('Chargement Management Component', () => {
    let comp: ChargementComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ChargementComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.chargements && comp.chargements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
